...
Para poder aplicar etiquetas a los recursos, primero debe crear un área de nombres y, a continuación, crear y agregarle etiquetas. También puede crear etiquetas y añadirlas a un área de nombres existente. Todas las etiquetas que cree en el nivel raíz se añaden automáticamente al área de nombres de etiquetas estándar. A continuación, puede añadir el campo Etiquetas al formulario de metadatos para que se muestre en la página Detalles del recurso. Después de configurar estos ajustes, puede comenzar a aplicar etiquetas a los recursos.
...
[!DNL Assets Essentials] permite a un administrador bloquear las etiquetas inteligentes de los recursos existentes y los recién añadidos. Para bloquear etiquetas, ejecute los siguientes pasos:
...
Assets Essentials permite exportar las etiquetas bloqueadas enumeradas al formato CSV. Para exportar la lista de bloqueados, ejecute los pasos siguientes:
